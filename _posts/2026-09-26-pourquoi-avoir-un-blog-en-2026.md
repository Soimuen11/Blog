...
vous pouvez généraliser en "site web". Je fais partie de ces personnes pénibles
convaincues que tout individu qui souhaite avoir son mot à dire sur Internet en
...
accessible que ce que pourraient croire bien des gens.

De nos jours, plus besoin de savoir coder ou d'avoir des connaissances très
poussées en développement web ou en administration de serveur. De nombreux
sites (CMS = Content Management System) comme
...
J'ai notamment choisi [Jekyll](https://jekyllrb.com/) ainsi que [Github
Pages](https://docs.github.com/en/pages/setting-up-a-github-pages-site-with-jekyll/about-github-pages-and-jekyll),
...
j'ai fait m'est extrêmement confortable, exploitant à la fois la puissance de
Vim et de [Tmux](https://tmux.app/) (deux programmes que je vous recommande
vivement, notamment si vous passez trop de temps dans votre terminal vous
aussi 😂).

## Au nom de la liberté ?

Je n'ai pas l'intention de lancer un débat politique ici. Du moins, pas
aujourd'hui (soyez patient, ça arrivera bien assez tôt). En revanche, je
...
*votre propre espace sur le web*. Que ce soit un blog ou tout autre type de
site web.
...
en 2026. Au contraire, c'est même un excellent moment pour commencer.

## Conclusion

Vous l'aurez compris, j'ai remis ce blog au goût du jour pour donner mon
avis... Sur tout et sur rien (surtout sur rien d'ailleurs), je vous rassure, je
n'ai pas l'intention de devenir activiste (non, vraiment, pitié, tout mais pas
ça). Je me tape juste un kiff, c'est tout. Pis je suis chez moi ici, je fais ce
que je veux wesh (utiliser le mot wesh par exemple, si ça me fait kiffer, vous
voyez ?).
