---
layout: post
title:  "Pourquoi avoir un blog en 2026 ?"
date: 2026-08-08 14:30:00
---

# Une brève introduction, comme pour tout propos...

Au risque de vous décevoir, je ne suis pas convaincu d'avoir un point de vue
très innovant en la matière. Si le titre de ce post fait référence à un "blog",
vous pouvez généraliser en "site web". Je fais partie des personnes convaincues
que tout individu qui souhaite avoir son mot à dire sur Internet en 2026
devrait avoir un espace qui lui appartient. Loin de moi l'idée de cracher mon
venin sur les réseaux sociaux, ce n'est certainement pas l'objectif. Je ne juge
pas non plus ceux qui s'y expriment, ni qui que ce soit. D'autres défendent ce
point de vue depuis plus longtemps que moi mais j'aimerais ajouter ma pierre à
cet édifice.

# Comment sauter le pas ?

Avoir un site web, et plus précisément un blog, est en fait bien plus
accessible que ce que pourraient croire bien des gens. De nos jours, plus
besoin de savoir coder ou d'avoir des connaissances très poussées en
développement web ou en administration de serveur. De nombreux sites (CMS =
Content Management System) comme WordPress, Wix, ou autres, proposent déjà un
service complet, vous assistant de la construction à la mise en ligne de votre
site. Le service est parfois plus ou moins cher, mais des alternatives
nettement moins onéreuses existent pour héberger votre site, mais aussi pour
gérer le nom de domaine de votre choix.
...
J'ai notamment choisi Jekyll ainsi que Github Pages, mais j'aurais également pu
m'orienter sur un mix entre Netlify et Hugo. Cela me permet de sauvegarder
facilement mon site à plusieurs endroits, sans qu'il ne prenne excessivement de
place sur Github ou mon serveur, mais aussi de rédiger mes posts en markdown,
directement depuis mon éditeur de texte favori : j'ai nommé Vim. Il me faudrait
dédier un post entièrement à mon setup, je ne m'attarderai donc pas dessus
aujourd'hui, sachez toutefois que le choix que j'ai fait m'est extrêmement
confortable, exploitant à la fois la puissance de Vim et de Tmux.

# Au nom de la liberté ?

Je n'ai pas l'intention de lancer un débat politique ici. En revanche, je
souhaite vous partager une réflexion que vous pourrez ensuite vous approprier.
...
+ avoir son propre espace d'expression et de liberté / sa propre existence sur le web ; ne pas être prisonnier d'un algorithme
+ amener davantage de diversité / faire vivre le web et ne pas laisser les grandes plateformes conserver un monopole total
+ mais Philippe, l'IA elle sait écrire mieux que toi... et gna gna gna... c'est
  des conneries ; si vous voulez dire quelque chose et que le blog est le bon
